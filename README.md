...
Each generated report is also saved under `data/cases/<timestamp>-<subject>/` with a `case.json` snapshot, any uploaded source files under `documents/`, and an `evidence_bundle.md` / `bundle.json` export for the snapshot.
